...
# Page config
st.set_page_config(page_title="Time Series Wizard", page_icon="favicon.jpeg", layout="wide", initial_sidebar_state="auto")
...
with st.expander(
    "Web App to build time series forecasting models in a few clicks!", expanded=False
):
